...
static bool_t hmc5883l_receive(uint8_t address, int8_t *data, uint8_t size)
{
    msg_t rv;
	
    rv = i2cMasterTransmitTimeout(&I2CD2, HMC5883L_I2C_READ_ADDR, &address, 1, data, size, 100);
